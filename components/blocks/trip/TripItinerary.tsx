...
export function TripItinerary({ itinerary, bgImage }: TripItineraryProps) {
          ...
          {itinerary.map((item, i) => (
            <li
              ...
              style={{
                ...
                borderBottom: i < itinerary.length - 1 ? `1px solid rgba(var(--pm-purple-rgb),${bgImage ? '0.25' : '0.1'})` : 'none',
              }}
            >
              {/* Day marker */}
              <div
                className="flex flex-col items-center gap-2 py-8 px-4"
                style={{ borderRight: `1px solid rgba(var(--pm-purple-rgb),${bgImage ? '0.3' : '0.15'})` }}
              >
                <p className="font-heading text-[2.5rem] leading-none" style={{ color: 'rgba(var(--pm-purple-rgb),0.7)' }}>
                  {String(item.day).padStart(2, '0')}
                </p>
                <div className="size-2 rounded-full" style={{ background: 'var(--pm-purple)' }} />
                <div
