...
export function TripClubs({ clubs }: TripClubsProps) {
  ...
  return (
    <section
      style={{
        background: 'radial-gradient(ellipse at center top, rgba(107,95,204,0.1) 0%, transparent 60%), var(--pm-midnight)',
        borderTop: '1px solid rgba(107,95,204,0.2)',
        borderBottom: '1px solid rgba(107,95,204,0.2)',
        position: 'relative',
        zIndex: 2,
      }}
    >
      <div className="px-6 md:px-12 py-24">
        <RevealOnScroll>
          <p className="text-[0.6rem] tracking-[0.5em] uppercase mb-4" style={{ color: '#FF2D78' }}>Two Nights Out</p>
        ...
        <div className="grid sm:grid-cols-2 gap-[1.5px]" style={{ background: 'rgba(107,95,204,0.12)' }}>
          {clubs.map((club, i) => (
            <RevealOnScroll key={club.id ?? i} delay={i * 0.08}>
              ...
              >
                <span
                  ...
                  style={{ color: 'rgba(107,95,204,0.08)' }}
                >
                ...
                {club.badge && (
                  <span
                    ...
                    style={{ background: 'rgba(255,45,120,0.15)', color: 'rgba(255,150,190,0.9)', border: '1px solid rgba(255,45,120,0.3)' }}
                  >
                    {club.badge}
                  </span>
                )}
                ...
                {club.vibe && (
                  <p className="text-[0.65rem] tracking-[0.3em] uppercase mb-4 font-medium" style={{ color: 'rgba(157,78,221,0.6)' }}>
                    {club.vibe}
                  </p>
                )}
        ...
        <RevealOnScroll>
          <div
            ...
            style={{ border: '1px solid rgba(107,95,204,0.15)', background: 'rgba(107,95,204,0.05)' }}
          >
