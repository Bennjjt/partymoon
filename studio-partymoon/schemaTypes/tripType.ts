...
export const tripType = defineType({
  ...
  groups: [
    ...
    {name: 'media', title: 'Section Backgrounds'},
  ...
  fields: [
    ...
    defineField({
      name: 'regionSvgPath',
      title: 'Region SVG path',
      type: 'text',
      group: 'detail',
      description:
        'SVG path `d` attribute for the destination country/region silhouette. Generated by scripts/generate-destination-svgs — paste the output here.',
    }),
    defineField({
      name: 'regionSvgViewBox',
      title: 'Region SVG viewBox',
      type: 'string',
      group: 'detail',
      description:
        'viewBox string from the generated SVG, e.g. "0 0 240 300". Paired with Region SVG path above.',
    }),
    defineField({
      name: 'introText',
    ...
    // Each field is optional. When supplied, the relevant section renders
    // the image as a full-bleed background with a consistent brand overlay.
    defineField({
      name: 'inclusionsBgImage',
      title: 'Inclusions section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the "What\'s In It" inclusions section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'itineraryBgImage',
      title: 'Itinerary section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the weekend itinerary section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'clubsBgImage',
      title: 'Clubs section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the nightclub highlights section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'hotelOptionsBgImage',
      title: 'Hotel options section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the hotel options section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'signatureExperienceBgImage',
      title: 'Signature experience section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the signature experience section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'spaBgImage',
      title: 'Spa section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the spa & wellness section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'diningBgImage',
      title: 'Dining section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the dining experiences section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
    defineField({
      name: 'hostsBgImage',
      title: 'Hosts section — background image',
      type: 'image',
      group: 'media',
      options: {hotspot: true},
      description: 'Background image for the your hosts section.',
      fields: [defineField({name: 'alt', type: 'string', title: 'Alt text'})],
    }),
